  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-4 md:px-6 py-8 md:py-16">
        {/* Author Info & Actions */}
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 md:mb-16 pb-6 md:pb-8 border-b border-gray-200 gap-4">
      ...
      {/* Newsletter Signup */}
      <section className="bg-gradient-to-r from-[var(--accent-1)] to-[var(--accent-3)] py-12 md:py-20">
        <div className="max-w-4xl mx-auto px-4 md:px-6 text-center">
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-6 md:p-12">
            <h2 className="text-2xl md:text-4xl font-bold text-white mb-4 md:mb-6">
              Never Miss an Update
            </h2>
            <p className="text-base md:text-xl text-white/90 mb-6 md:mb-10 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 max-w-lg mx-auto">
              <input
                ...
                className="flex-1 px-4 py-3 md:px-6 md:py-4 rounded-xl border-0 focus:ring-2 focus:ring-white/50 outline-none text-base md:text-lg"
              />
              <button className="bg-white text-[var(--accent-1)] px-6 py-3 md:px-8 md:py-4 rounded-xl font-semibold hover:bg-gray-100 transition-colors text-base md:text-lg">
                Subscribe
              </button>
            </div>
